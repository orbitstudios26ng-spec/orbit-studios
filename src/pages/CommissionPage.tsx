...
export default function CommissionPage() {
  return (
    <SiteLayout>
      <section className="container grid gap-10 px-4 py-14 md:py-24 lg:grid-cols-[0.8fr_1.2fr]">
        <div className="space-y-6">
          <p className="text-xs uppercase tracking-[0.35em] text-primary">Commission form</p>
          <h1 className="text-3xl font-semibold sm:text-4xl md:text-6xl">Send a project brief</h1>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-5 text-sm leading-8 text-white/65">
      ...
      <section className="container px-4 pb-20">
        <div className="space-y-4">
          ...
          <h2 className="text-2xl font-semibold sm:text-3xl md:text-5xl">Pricing guide for commissions.</h2>
        </div>
