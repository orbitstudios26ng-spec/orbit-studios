  ...
  return (
    <SiteLayout>
      <section className="relative overflow-hidden">
        ...
        <div className="container relative grid gap-14 px-4 py-20 md:grid-cols-[1.2fr_0.8fr] md:py-28">
      ...
      <section className="container px-4 py-20">
        <div className="mb-10 flex items-end justify-between gap-6">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold md:text-5xl">Public projects currently available to review.</h2>
          </div>
              ...
              <div className="space-y-4 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span key={tag} className="rounded-full bg-black/30 px-3 py-1 text-xs text-white/60">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <section className="border-y border-white/10 bg-black/20">
        <div className="container grid gap-6 px-4 py-20 md:grid-cols-2 xl:grid-cols-4">
      ...
      <section className="container px-4 py-20">
        <div className="max-w-3xl space-y-5">
          ...
          <h2 className="text-3xl font-semibold md:text-5xl">Current service rates.</h2>
      ...
      <section className="container px-4 pb-24 pt-20">
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-[0.35em] text-primary">Approach</p>
            <h2 className="text-3xl font-semibold md:text-5xl">A smaller body of work, presented honestly.</h2>
          </div>
